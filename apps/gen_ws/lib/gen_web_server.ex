defmodule GenWebServer do
  ...
  @callback get(request, headers, user_data) :: reply()
  @callback delete(request, headers, user_data) :: reply()
  @callback head(request, headers, user_data) :: reply()
  @callback post(request, headers, body, user_data) :: reply()
  @callback put(request, headers, body, user_data) :: reply()
  @callback other(method, request, headers, body, user_data) :: reply()
